...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #-----------------------------------------------------------------------------------------------------------------#
      [    :open_projects_tab         ,    'Open'          ,    openlist_path         ,    true        ,    true        ],
      [    :closed_projects_tab       ,    'Closed'        ,    closedlist_path       ,    true        ,    true        ],
      [    :suspended_projects_tab    ,    'Suspended'     ,    suspendedlist_path    ,    true        ,    true        ],
      #-----------------------------------------------------------------------------------------------------------------#
      #    TAB NAME                   |    DISPLAY TEXT    |    PATH                  |    VISIBLE?    |    ENABLED?    #
      #-----------------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #---------------------------------------------------------------------#
      [    :users        ,    :open         ,    :open_projects_tab         ],
      [    :users        ,    :closed       ,    :closed_projects_tab       ],
      [    :users        ,    :suspended    ,    :suspended_projects_tab    ],
      [    :users        ,    :tabsframe    ,    :open_projects_tab         ],
      #---------------------------------------------------------------------#
      #    CONTROLLER    |    ACTION        |    TAB                        #
      #---------------------------------------------------------------------#
    ]
